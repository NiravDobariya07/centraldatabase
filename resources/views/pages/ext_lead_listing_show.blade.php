...
@section('page-title', config('app.name') . ' - Ext Lead Show')
              ...
              <div class="col-sm-12">
                ...
                <div class="card-body">
                    <div class="row justify-content-between">
                        <h5 class="card-title text-primary mb-4 col-4">Ext Lead Details</h5>
                        <a href="{{ route('ext-lead-listing.index') }}" class="col-4 mb-4 btn btn-primary w-auto">Back</a>
                    </div>
