        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="admin-login-form" class="mb-3" action="{{ route('admin.login.post') }}" method="POST">
                @csrf
                <div class="mb-3">
      ...
      $(document).ready(function () {
        ...
        $("#admin-login-form").validate({
            rules: {
                email: {
                    required: true,
                    email: true, // jQuery Validation built-in method for email format
                },
                password: {
                    required: true,
                    minlength: 8, // Minimum length for password (adjust as needed)
                },
                keep_signed_in: {
                    required: false, // Optional checkbox, no validation required
                },
            },
            messages: {
                email: {
            ...
            errorPlacement: function (error, element) {
                ...
                if (element.attr("name") === "password") {
                  error.insertAfter(".password-input-group");
                    ...
                    error.insertAfter(element); // Default placement for other inputs
                }
            },
