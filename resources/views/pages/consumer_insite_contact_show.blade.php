...
@section('page-title', config('app.name') . ' - Consumer Insite Contact Show')
              ...
              <div class="col-sm-12">
                <div class="card-body">
                    <div class="row justify-content-between">
                        <h5 class="card-title text-primary mb-4 col-4">Consumer Insite Contact Details</h5>
                        <a href="{{ route('consumer-insite-contacts.index') }}" class="col-4 mb-4 btn btn-primary w-auto">Back</a>
                    </div>
