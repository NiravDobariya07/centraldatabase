        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="admin-forgot-password-form" class="mb-3" action="{{ route('admin.send-password-reset-link') }}" method="POST">
                @csrf
                <div class="mb-3">
                  ...
                  />
                  @error('email')
                    <label class="error server-error">{{ $message }}</label>
                  @enderror
                </div>
      ...
      $(document).ready(function () {
        ...
        $("#admin-forgot-password-form").validate({
          ...
          submitHandler: function (form) {
              // You can add additional submit logic if needed
              form.submit();
              $("#preloader").show();
          },
          errorPlacement: function (error, element) {
              // Remove any previous error messages for this field before placing the new one
