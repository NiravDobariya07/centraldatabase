        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="admin-password-reset-form" class="mb-3" action="{{ route('password.update') }}" method="POST">
                @csrf
        ...
        $(document).ready(function () {
            $("#admin-password-reset-form").validate({
                ...
                errorPlacement: function (error, element) {
                    if (element.closest(".password-input-group").length) {
                        error.insertAfter(element.closest(".password-input-group"));
                    } else {
